...
var articulo        = context.request.method == 'POST' ? context.request.parameters.custpage_selectfieldmes2.split(delimiter) : "";
  ...
  var anio_ini        = f_Inicio.split("/")[2];
    ...
    var form        = serverWidget.createForm({
      title: 'Historial de venta por Vendedor',
      hideNavBar: false
    });
  ...
  var selectField2 = form.addField({
    id : 'custpage_selectfieldmes2',
  ...
  selectField2.addSelectOption({
    value : 'FABIOLA CANALES RAMOS',
    text : 'FABIOLA CANALES RAMOS'
  });
  selectField2.addSelectOption({
    value : 'DANIELA YESENIA CANALES RAMOS',
    text : 'DANIELA YESENIA CANALES RAMOS'
  });
  selectField2.addSelectOption({
    value : 'DANIELA YESENIA CANALES RAMOS',
    text : 'DANIELA YESENIA CANALES RAMOS'
  ...
  selectField2.addSelectOption({
    value : 'LAURA VIANEY GARCIA',
    text : 'LAURA VIANEY GARCIA'
  });
  selectField2.addSelectOption({
    value : 'AURORA CATALINA DOMINGUEZ ISLAS',
    text : 'AURORA CATALINA DOMINGUEZ ISLAS'
  });
  selectField2.addSelectOption({
    value : 'GABRIEL TRELLES LARA',
    text : 'GABRIEL TRELLES LARA'
  });
  selectField2.addSelectOption({
    value : 'JENNIFER YAMILET ARREZOLA JAIMES',
    text : 'JENNIFER YAMILET ARREZOLA JAIMES'
  });
  selectField2.addSelectOption({
    value : 'NUBIA AZUCENA MARTINEZ BALTAZAR',
    text : 'NUBIA AZUCENA MARTINEZ BALTAZAR'
  });
  selectField2.addSelectOption({
    value : 'YOLANDA VERONICA VILLA MONTES',
    text : 'YOLANDA VERONICA VILLA MONTES'
  });
  selectField2.addSelectOption({
    value : 'LUIS RAMON JUAREZ MARTINEZ',
    text : 'LUIS RAMON JUAREZ MARTINEZ'
  });
  selectField2.addSelectOption({
    value : 'ANA KAREN SERRANO SOLIS',
    text : 'ANA KAREN SERRANO SOLIS'
  });
  selectField2.addSelectOption({
    value : 'EDUARDO FERNANDO LOPEZ SANCHEZ',
    text : 'EDUARDO FERNANDO LOPEZ SANCHEZ'
  });
  selectField2.addSelectOption({
    value : 'ISABEL ROSAS SANCHEZ',
    text : 'ISABEL ROSAS SANCHEZ'
  });
  selectField2.addSelectOption({
    value : 'YOLTIC MIRAMONTES VILLALVAZO',
    text : 'YOLTIC MIRAMONTES VILLALVAZO'
  });
  selectField2.addSelectOption({
    value : 'KARLA LIZBETH MENA FERNANDEZ',
    text : 'KARLA LIZBETH MENA FERNANDEZ'
  });
  selectField2.addSelectOption({
    value : 'ERICK DANIEL SANCHEZ CORONA',
    text : 'ERICK DANIEL SANCHEZ CORONA'
  });
  selectField2.addSelectOption({
    value : 'JOSE JIMENEZ BELTRAN',
    text : 'JOSE JIMENEZ BELTRAN'
  });
  selectField2.addSelectOption({
    value : 'GILBERTO RIVAS MARES',
    text : 'GILBERTO RIVAS MARES'
  });
  selectField2.addSelectOption({
    value : 'ESTEBAN BENCOMO LOMELI',
    text : 'ESTEBAN BENCOMO LOMELI'
  });
  selectField2.addSelectOption({
    value : 'DANIELA MONSERRAT ANDRADE GARCIA',
    text : 'DANIELA MONSERRAT ANDRADE GARCIA'
  });
  selectField2.addSelectOption({
    value : 'ESTEFANIA BENITEZ GARCIA',
    text : 'ESTEFANIA BENITEZ GARCIA'
  });
  selectField2.addSelectOption({
    value : 'GEMMA MARGARITA GARCIA CORTES',
    text : 'GEMMA MARGARITA GARCIA CORTES'
  });
  selectField2.addSelectOption({
    value : 'MARIA MARISOL ABARCA MACIAS',
    text : 'MARIA MARISOL ABARCA MACIAS'
  });
  selectField2.addSelectOption({
    value : 'FERNANDO CHACON GARCIA',
    text : 'FERNANDO CHACON GARCIA'
  });
  selectField2.addSelectOption({
    value : 'THALIA LIZETTE TORRES MAGAÑA',
    text : 'THALIA LIZETTE TORRES MAGAÑA'
  });
  selectField2.addSelectOption({
    value : 'GLORIA VANESSA VELEZ CASTILLO',
    text : 'GLORIA VANESSA VELEZ CASTILLO'
  });
  selectField2.addSelectOption({
    value : 'MARCOS JAVIER LOZA GARCIA',
    text : 'MARCOS JAVIER LOZA GARCIA'
  });
  selectField2.addSelectOption({
    value : 'GLORIA VANESSA VELEZ CASTELLANOS',
    text : 'GLORIA VANESSA VELEZ CASTELLANOS'
  });
  selectField2.addSelectOption({
    value : 'MA. MAGNOLIA REAL RODRIGUEZ',
    text : 'MA. MAGNOLIA REAL RODRIGUEZ'
  });
  selectField2.addSelectOption({
    value : 'BETCY ALEJANDRA ESPINOZA CUEVAS',
    text : 'BETCY ALEJANDRA ESPINOZA CUEVAS'
  });
  selectField2.addSelectOption({
    value : 'ETZHEL BEATRIZ BURCIAGA SERRANO',
    text : 'ETZHEL BEATRIZ BURCIAGA SERRANO'
  });
  selectField2.addSelectOption({
    value : 'ANA LILIA RAMIREZ SANCHEZ',
    text : 'ANA LILIA RAMIREZ SANCHEZ'
  });
  selectField2.addSelectOption({
    value : 'LUIZ FELIPE VARGAS AGUILAR',
    text : 'LUIZ FELIPE VARGAS AGUILAR'
  });
  selectField2.addSelectOption({
    value : 'NANCY ESTEFANIA HEREDIA REYNOSO',
    text : 'NANCY ESTEFANIA HEREDIA REYNOSO'
  });
  selectField2.addSelectOption({
    value : 'VALERIA CRISTINA CAMPOS SANDOVAL',
    text : 'VALERIA CRISTINA CAMPOS SANDOVAL'
  });
  selectField2.addSelectOption({
    value : 'VIANEY VERA ALVAREZ',
    text : 'VIANEY VERA ALVAREZ'
  });
  selectField2.addSelectOption({
    value : 'VERONICA MEDINA VACA',
    text : 'VERONICA MEDINA VACA'
  });
  selectField2.addSelectOption({
    value : 'KENIA ITZEL VENTURA RODRIGUEZ',
    text : 'KENIA ITZEL VENTURA RODRIGUEZ'
  });
  selectField2.addSelectOption({
    value : 'LUIS FERNANDO MALDONADO TENA',
    text : 'LUIS FERNANDO MALDONADO TENA'
  });
  selectField2.addSelectOption({
    value : 'ANA MARIA ROBLES SALINAS',
    text : 'ANA MARIA ROBLES SALINAS'
  });
  selectField2.addSelectOption({
    value : 'EDER RIGOBERTO MORALES CORONADO',
    text : 'EDER RIGOBERTO MORALES CORONADO'
  });

 

  selectField2.isMandatory = true;
  selectField2.defaultValue = articulo;
...
if(customrecord687==1){
 sqlPrincipal= 
 " SELECT *,'0' mes,'2024' AÑO, from(SELECT  "+
 "     item_conlt_prim.articulo, item_conlt_prim.*from(select*from(SELECT articulo, "+
 "     cantidad, "+
 "     venta_neta, "+
 "     ROUND(Utilidad, "+
 "     0) utilidad_en_Pesos, "+
 ...
 " WHERE   transaction.custbodycustrecord_vendedor_msp in ('"+articulo+"') "+
 "     AND transactionline.itemtype='InvtPart' "+
 "     AND transactiON .tranDate >=TO_DATE('"+fecha +"', 'MM/DD/YYYY')  "+
 "     AND transactiON .tranDate  <= TO_DATE('"+fecha2 +"', 'MM/DD/YYYY') "+
 ...
 " ON total_Ingresos.itm=DEVOLUCIONES_Compra.itm ))) item_conlt_prim )"
   ...
   sqlPrincipal=     " SELECT *,'0' mes,'2024' AÑO, from(SELECT  "+
"     item_conlt_prim.articulo, item_conlt_prim.*from(select*from(SELECT articulo, "+
"     cantidad, "+
"     venta_neta, "+
"     ROUND(Utilidad, "+
...
" SELECT *,'2' mes,'2024' AÑO, from(SELECT  "+
"     item_conlt_prim.articulo, item_conlt_prim.*from(select*from(SELECT articulo, "+
"     cantidad, "+
"     venta_neta, "+
"     ROUND(Utilidad, "+
...
" WHERE  transaction.custbodycustrecord_vendedor_msp in ('"+articulo+"') "+
"     AND transactionline.itemtype='InvtPart' "+
"     AND transactiON .tranDate >=TO_DATE('02/01/2024', 'MM/DD/YYYY')  "+
"     AND transactiON .tranDate  <= TO_DATE('02/29/2024', 'MM/DD/YYYY') "+
"     AND transactionline.location in ("+location+")  "+
"     AND transactiON .type='SalesOrd' "+
" GROUP BY   transaction.custbodycustrecord_vendedor_msp ) AS total_Ingresos "+
" LEFT JOIN (SELECT sum(netamount)*-1 valor_1_para__el_5 , "+
...
"   )   "
    ...
    if(customrecord687==3){
        ...
        " SELECT *,'1' mes,'2024' AÑO, from(SELECT  "+
        "     item_conlt_prim.articulo, item_conlt_prim.*from(select*from(SELECT articulo, "+
        "     cantidad, "+
        "     venta_neta, "+
        "     ROUND(Utilidad, "+
        ...
        " WHERE  transaction.custbodycustrecord_vendedor_msp in ('"+articulo+"') "+
        "     AND transactionline.itemtype='InvtPart' "+
        "     AND transactiON .tranDate >=TO_DATE('01/01/2024', 'MM/DD/YYYY')  "+
        "     AND transactiON .tranDate  <= TO_DATE('01/31/2024', 'MM/DD/YYYY') "+
        "     AND transactionline.location in ("+location+")  "+
        "     AND transactiON .type='SalesOrd' "+
        " GROUP BY   transaction.custbodycustrecord_vendedor_msp ) AS total_Ingresos "+
        " LEFT JOIN (SELECT sum(netamount)*-1 valor_1_para__el_5 , "+
        ...
        " SELECT *,'12' mes,'2023' AÑO, from(SELECT  "+
        "     item_conlt_prim.articulo, item_conlt_prim.*from(select*from(SELECT articulo, "+
        "     cantidad, "+
        "     venta_neta, "+
        "     ROUND(Utilidad, "+
        ...
        " WHERE  transaction.custbodycustrecord_vendedor_msp in ('"+articulo+"') "+
        "     AND transactionline.itemtype='InvtPart' "+
        "     AND transactiON .tranDate >=TO_DATE('12/01/2023', 'MM/DD/YYYY')  "+
        "     AND transactiON .tranDate  <= TO_DATE('12/31/2023', 'MM/DD/YYYY') "+
        "     AND transactionline.location in ("+location+")  "+
        "     AND transactiON .type='SalesOrd' "+
        " GROUP BY   transaction.custbodycustrecord_vendedor_msp ) AS total_Ingresos "+
        " LEFT JOIN (SELECT sum(netamount)*-1 valor_1_para__el_5 , "+
    ...
    if(customrecord687==4){
        ...
        " SELECT *,'11' mes,'2023' AÑO, from(SELECT  "+
        "     item_conlt_prim.articulo, item_conlt_prim.*from(select*from(SELECT articulo, "+
        "     cantidad, "+
        "     venta_neta, "+
        "     ROUND(Utilidad, "+
        ...
        " WHERE  transaction.custbodycustrecord_vendedor_msp in ('"+articulo+"') "+
        "     AND transactionline.itemtype='InvtPart' "+
        "     AND transactiON .tranDate >=TO_DATE('11/01/2023', 'MM/DD/YYYY')  "+
        "     AND transactiON .tranDate  <= TO_DATE('11/30/2023', 'MM/DD/YYYY') "+
        "     AND transactionline.location in ("+location+")  "+
        "     AND transactiON .type='SalesOrd' "+
        " GROUP BY   transaction.custbodycustrecord_vendedor_msp ) AS total_Ingresos "+
        " LEFT JOIN (SELECT sum(netamount)*-1 valor_1_para__el_5 , "+
        ...
        " SELECT *,'10' mes,'2023' AÑO, from(SELECT  "+
        "     item_conlt_prim.articulo, item_conlt_prim.*from(select*from(SELECT articulo, "+
        "     cantidad, "+
        "     venta_neta, "+
        "     ROUND(Utilidad, "+
        ...
        " WHERE  transaction.custbodycustrecord_vendedor_msp in ('"+articulo+"') "+
        "     AND transactionline.itemtype='InvtPart' "+
        "     AND transactiON .tranDate >=TO_DATE('10/01/2023', 'MM/DD/YYYY')  "+
        "     AND transactiON .tranDate  <= TO_DATE('10/31/2023', 'MM/DD/YYYY') "+
        "     AND transactionline.location in ("+location+")  "+
        "     AND transactiON .type='SalesOrd' "+
        " GROUP BY   transaction.custbodycustrecord_vendedor_msp ) AS total_Ingresos "+
        " LEFT JOIN (SELECT sum(netamount)*-1 valor_1_para__el_5 , "+
        ...
        " SELECT *,'9' mes,'2023' AÑO, from(SELECT  "+
        "     item_conlt_prim.articulo, item_conlt_prim.*from(select*from(SELECT articulo, "+
        "     cantidad, "+
        "     venta_neta, "+
        "     ROUND(Utilidad, "+
        ...
        " WHERE  transaction.custbodycustrecord_vendedor_msp in ('"+articulo+"') "+
        "     AND transactionline.itemtype='InvtPart' "+
        "     AND transactiON .tranDate >=TO_DATE('09/01/2023', 'MM/DD/YYYY')  "+
        "     AND transactiON .tranDate  <= TO_DATE('09/30/2023', 'MM/DD/YYYY') "+
        "     AND transactionline.location in ("+location+")  "+
        "     AND transactiON .type='SalesOrd' "+
        " GROUP BY   transaction.custbodycustrecord_vendedor_msp ) AS total_Ingresos "+
        " LEFT JOIN (SELECT sum(netamount)*-1 valor_1_para__el_5 , "+
    ...
    if(customrecord687==5){
        ...
        " SELECT *,'8' mes,'2023' AÑO, from(SELECT  "+
        "     item_conlt_prim.articulo, item_conlt_prim.*from(select*from(SELECT articulo, "+
        "     cantidad, "+
        "     venta_neta, "+
        "     ROUND(Utilidad, "+
        ...
        " WHERE  transaction.custbodycustrecord_vendedor_msp in ('"+articulo+"') "+
        "     AND transactionline.itemtype='InvtPart' "+
        "     AND transactiON .tranDate >=TO_DATE('08/01/2023', 'MM/DD/YYYY')  "+
        "     AND transactiON .tranDate  <= TO_DATE('08/31/2023', 'MM/DD/YYYY') "+
        "     AND transactionline.location in ("+location+")  "+
        "     AND transactiON .type='SalesOrd' "+
        " GROUP BY   transaction.custbodycustrecord_vendedor_msp ) AS total_Ingresos "+
        " LEFT JOIN (SELECT sum(netamount)*-1 valor_1_para__el_5 , "+
        ...
        " SELECT *,'7' mes,'2023' AÑO, from(SELECT  "+
        "     item_conlt_prim.articulo, item_conlt_prim.*from(select*from(SELECT articulo, "+
        "     cantidad, "+
        "     venta_neta, "+
        "     ROUND(Utilidad, "+
        ...
        " WHERE  transaction.custbodycustrecord_vendedor_msp in ('"+articulo+"') "+
        "     AND transactionline.itemtype='InvtPart' "+
        "     AND transactiON .tranDate >=TO_DATE('07/01/2023', 'MM/DD/YYYY')  "+
        "     AND transactiON .tranDate  <= TO_DATE('07/31/2023', 'MM/DD/YYYY') "+
        "     AND transactionline.location in ("+location+")  "+
        "     AND transactiON .type='SalesOrd' "+
        " GROUP BY   transaction.custbodycustrecord_vendedor_msp ) AS total_Ingresos "+
        " LEFT JOIN (SELECT sum(netamount)*-1 valor_1_para__el_5 , "+
        ...
        " SELECT *,'6' mes,'2023' AÑO, from(SELECT  "+
        "     item_conlt_prim.articulo, item_conlt_prim.*from(select*from(SELECT articulo, "+
        "     cantidad, "+
        "     venta_neta, "+
        "     ROUND(Utilidad, "+
        ...
        " WHERE  transaction.custbodycustrecord_vendedor_msp in ('"+articulo+"') "+
        "     AND transactionline.itemtype='InvtPart' "+
        "     AND transactiON .tranDate >=TO_DATE('06/01/2023', 'MM/DD/YYYY')  "+
        "     AND transactiON .tranDate  <= TO_DATE('06/30/2023', 'MM/DD/YYYY') "+
        "     AND transactionline.location in ("+location+")  "+
        "     AND transactiON .type='SalesOrd' "+
        " GROUP BY   transaction.custbodycustrecord_vendedor_msp ) AS total_Ingresos "+
        " LEFT JOIN (SELECT sum(netamount)*-1 valor_1_para__el_5 , "+
        ...
        " SELECT *,'5' mes,'2023' AÑO, from(SELECT  "+
        "     item_conlt_prim.articulo, item_conlt_prim.*from(select*from(SELECT articulo, "+
        "     cantidad, "+
        "     venta_neta, "+
        "     ROUND(Utilidad, "+
        ...
        " WHERE  transaction.custbodycustrecord_vendedor_msp in ('"+articulo+"') "+
        "     AND transactionline.itemtype='InvtPart' "+
        "     AND transactiON .tranDate >=TO_DATE('05/01/2023', 'MM/DD/YYYY')  "+
        "     AND transactiON .tranDate  <= TO_DATE('05/31/2023', 'MM/DD/YYYY') "+
        "     AND transactionline.location in ("+location+")  "+
        "     AND transactiON .type='SalesOrd' "+
        " GROUP BY   transaction.custbodycustrecord_vendedor_msp ) AS total_Ingresos "+
        " LEFT JOIN (SELECT sum(netamount)*-1 valor_1_para__el_5 , "+
        ...
        " SELECT *,'4' mes,'2023' AÑO, from(SELECT  "+
        "     item_conlt_prim.articulo, item_conlt_prim.*from(select*from(SELECT articulo, "+
        "     cantidad, "+
        "     venta_neta, "+
        "     ROUND(Utilidad, "+
        ...
        " WHERE  transaction.custbodycustrecord_vendedor_msp in ('"+articulo+"') "+
        "     AND transactionline.itemtype='InvtPart' "+
        "     AND transactiON .tranDate >=TO_DATE('04/01/2023', 'MM/DD/YYYY')  "+
        "     AND transactiON .tranDate  <= TO_DATE('04/30/2023', 'MM/DD/YYYY') "+
        "     AND transactionline.location in ("+location+")  "+
        "     AND transactiON .type='SalesOrd' "+
        " GROUP BY   transaction.custbodycustrecord_vendedor_msp ) AS total_Ingresos "+
        " LEFT JOIN (SELECT sum(netamount)*-1 valor_1_para__el_5 , "+
        ...
        " SELECT *,'3' mes,'2023' AÑO, from(SELECT  "+
        "     item_conlt_prim.articulo, item_conlt_prim.*from(select*from(SELECT articulo, "+
        "     cantidad, "+
        "     venta_neta, "+
        "     ROUND(Utilidad, "+
        ...
        " WHERE  transaction.custbodycustrecord_vendedor_msp in ('"+articulo+"') "+
        "     AND transactionline.itemtype='InvtPart' "+
        "     AND transactiON .tranDate >=TO_DATE('03/01/2023', 'MM/DD/YYYY')  "+
        "     AND transactiON .tranDate  <= TO_DATE('03/31/2023', 'MM/DD/YYYY') "+
        "     AND transactionline.location in ("+location+")  "+
        "     AND transactiON .type='SalesOrd' "+
        " GROUP BY   transaction.custbodycustrecord_vendedor_msp ) AS total_Ingresos "+
        " LEFT JOIN (SELECT sum(netamount)*-1 valor_1_para__el_5 , "+
...
var mes_texto="";
        ...
        else if (mes==2){mes_orden='1'}
        else if (mes==3){mes_orden='12'}
...
html += '$("#ttf").empty(); $("#ttf").append( `<tr><td  ></td>  <td  class="text-right ">`+col2+` </td>  <td  class="text-right ">`+col3+` </td> <td  class="text-right ">`+col4+` </td>  <td  class="text-right ">`+porcent1+`% </td>  </tr>` ); ';  
html += '  });'
