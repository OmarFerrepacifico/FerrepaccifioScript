...
define(['N/query', 'N/log', 'N/ui/serverWidget', 'N/runtime'], function(query, log, serverWidget, runtime){
  ...
  var articulo        = context.request.method == 'POST' ? context.request.parameters.custpage_item.split(delimiter) : "";
    ...
    var anio_ini        = f_Inicio.split("/")[2];
      ...
      var form        = serverWidget.createForm({
        title: 'Historial de venta por Cliente',
        hideNavBar: false
      });
  ...
  var cliente =articulo;
  
  fecha=mes_ini+"/"+dia_ini+"/"+ anio_ini;  fecha2=mes+"/"+dia+"/"+ anio;  
  if(customrecord687==1){ 
    var sqlPrincipal= "select '"+cliente+" ' cliente ,sum(cantidad)cantidad, sum(venta_neta)venta_neta, sum(utilidad_en_pesos)utilidad_en_pesos,Round((sum(utilidad_en_pesos)/sum(venta_neta))*100) utilidad ,'0' mes,Round(2024) AÑO, from(select item.displayname codigo,itm.venta_neta,itm.cantidad ,itm.utilidad_en_pesos  from(select articulo,venta_neta,cantidad, ROUND(Utilidad,2) utilidad_en_pesos ,round((ROUND(Utilidad,2)/venta_neta)*100,0)utilidad   from (select  total_Ingresos.desc articulo, total_Ingresos.cantidad*-1 cantidad ,  "+
  ...
  "  group by   transactionline.item,item.description  )) as itm join item on itm.articulo=item.description)"
     ...
     sqlPrincipal=     " SELECT *,'0' mes,Round(2024) AÑO, from(SELECT Customer.companyname cliente , "+
  "     item_conlt_prim.*from(select*from(SELECT articulo, "+
  "     cantidad, "+
  "     venta_neta, "+
  "     ROUND(Utilidad, "+
  "     0) utilidad_en_Pesos, "+
  ...
  " GROUP BY   transaction .entity  ) AS total_Ingresos "+
  ...
  " GROUP BY   transaction .entity  )AS valor_1_para__el_5 "+
  ...
  "     AND transactiON .type='SalesOrd' "+
  "     AND terms NOT in(4,20 ) "+
  " GROUP BY   transaction .entity  )AS valor_2_para__el_5 "+
  ...
  " GROUP BY   transaction .entity  ) AS DEVOLUCIONES "+
  ...
  " JOIN Customer "+
  " ON item_conlt_prim.articulo= Customer.id  )  union all  " +
  ...
  " SELECT *,'2' mes,Round(2024) AÑO, from(SELECT Customer.companyname cliente , "+
  "     item_conlt_prim.*from(select*from(SELECT articulo, "+
  "     cantidad, "+
  "     venta_neta, "+
  "     ROUND(Utilidad, "+
  ...
  " ON total_Ingresos.itm=DEVOLUCIONES_Compra.itm ))) item_conlt_prim "+
  " JOIN Customer "+
  " ON item_conlt_prim.articulo= Customer.id  )   "
      }
      if(customrecord687==3){
          ...
          " SELECT *,'1' mes,Round(2024) AÑO, from(SELECT Customer.companyname cliente , "+
          "     item_conlt_prim.*from(select*from(SELECT articulo, "+
          "     cantidad, "+
          "     venta_neta, "+
          "     ROUND(Utilidad, "+
          ...
          " SELECT *,'12' mes,Round(2023) AÑO, from(SELECT Customer.companyname cliente , "+
          "     item_conlt_prim.*from(select*from(SELECT articulo, "+
          "     cantidad, "+
          "     venta_neta, "+
          "     ROUND(Utilidad, "+
      ...
      if(customrecord687==4){
          ...
          " SELECT *,'11' mes,Round(2023) AÑO, from(SELECT Customer.companyname cliente , "+
          "     item_conlt_prim.*from(select*from(SELECT articulo, "+
          "     cantidad, "+
          "     venta_neta, "+
          "     ROUND(Utilidad, "+
          ...
          " SELECT *,'10' mes,Round(2023) AÑO, from(SELECT Customer.companyname cliente , "+
          "     item_conlt_prim.*from(select*from(SELECT articulo, "+
          "     cantidad, "+
          "     venta_neta, "+
          "     ROUND(Utilidad, "+
          ...
          " SELECT *,'9' mes,Round(2023) AÑO, from(SELECT Customer.companyname cliente , "+
          "     item_conlt_prim.*from(select*from(SELECT articulo, "+
          "     cantidad, "+
          "     venta_neta, "+
          "     ROUND(Utilidad, "+
      ...
      if(customrecord687==5){
          ...
          " SELECT *,'8' mes,Round(2023) AÑO, from(SELECT Customer.companyname cliente , "+
          "     item_conlt_prim.*from(select*from(SELECT articulo, "+
          "     cantidad, "+
          "     venta_neta, "+
          "     ROUND(Utilidad, "+
          ...
          " SELECT *,'7' mes,Round(2023) AÑO, from(SELECT Customer.companyname cliente , "+
          "     item_conlt_prim.*from(select*from(SELECT articulo, "+
          "     cantidad, "+
          "     venta_neta, "+
          "     ROUND(Utilidad, "+
          ...
          " SELECT *,'6' mes,Round(2023) AÑO, from(SELECT Customer.companyname cliente , "+
          "     item_conlt_prim.*from(select*from(SELECT articulo, "+
          "     cantidad, "+
          "     venta_neta, "+
          "     ROUND(Utilidad, "+
          ...
          " SELECT *,'5' mes,Round(2023) AÑO, from(SELECT Customer.companyname cliente , "+
          "     item_conlt_prim.*from(select*from(SELECT articulo, "+
          "     cantidad, "+
          "     venta_neta, "+
          "     ROUND(Utilidad, "+
          ...
          " SELECT *,'4' mes,Round(2023) AÑO, from(SELECT Customer.companyname cliente , "+
          "     item_conlt_prim.*from(select*from(SELECT articulo, "+
          "     cantidad, "+
          "     venta_neta, "+
          "     ROUND(Utilidad, "+
          ...
          " SELECT *,'3' mes,Round(2024) AÑO, from(SELECT Customer.companyname cliente , "+
          "     item_conlt_prim.*from(select*from(SELECT articulo, "+
          "     cantidad, "+
          "     venta_neta, "+
          "     ROUND(Utilidad, "+
          ...
          " WHERE  transaction .entity  in ("+articulo+") "+
          "     AND transactionline.itemtype='InvtPart' "+
          "     AND transactiON .tranDate >=TO_DATE('03/01/2024', 'MM/DD/YYYY')  "+
          "     AND transactiON .tranDate  <= TO_DATE('03/31/2024', 'MM/DD/YYYY') "+
          "     AND transactionline.location in ("+location+")  "+
          "     AND transactiON .type='SalesOrd' "+
          " GROUP BY   transaction .entity  ) AS total_Ingresos "+
          " LEFT JOIN (SELECT sum(netamount)*-1 valor_1_para__el_5 , "+
  ...
  var mes_texto="";
          ...
          var mes_orden="";
          if(mes==1){mes_orden='3'}
          else if (mes==2){mes_orden='2'}
          else if (mes==3){mes_orden='1'}
          else if (mes==4){mes_orden='12'}
          else if (mes==5){mes_orden='11'}
          else if (mes==6){mes_orden='10'}
          else if (mes==7){mes_orden='9'}
          else if (mes==8){mes_orden='8'}
          else if (mes==9){mes_orden='7'}
          else if (mes==10){mes_orden='6'}
          else if (mes==11){mes_orden='5'}
          else if (mes==12){mes_orden='4'}
          else {mes_orden='0'}
...
html += ' var table = $("#resultsTable").DataTable();' 
              ...
              // Obtener los datos de la columna con índice 5
             
html += ' var data = table.column(5).data();' 
              
              // Iterar sobre los datos y quitar los decimales
            
html += '  for (var i = 0; i < data.length; i++) {' 
              
html += '    var value = data[i];' 
                  // Convertir el valor a entero para eliminar los decimales
               
html += '   var intValue = parseInt(value);' 
                  // Asignar el nuevo valor a la celda
              
html += '    table.cell(i, 5).data(intValue);' 
